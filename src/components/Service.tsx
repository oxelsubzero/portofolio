  ...
  return (
    <div className="md:mt-[100px] mt-8">
      ...
      <div className="grid xl:grid-cols-2 md:mt-16 mt-16 mb-16 md:gap-[100px] gap-8 pl-4  md:pl-36 xl:pl-0">
        ...
        >
          <img src="/webdev.webp" alt="webdev" className="object-cover " />
        </ServiceCard>
        ...
        >
          <img src="/design.jpg" alt="webdev" className="object-cover h-full" />
        </ServiceCard>
        <ServiceCard
        ...
        >
          <img src="/next.jpg" alt="webdev" className="object-cover " />
        </ServiceCard>
        <ServiceCard
        ...
        >
          <img src="/backend.png" alt="webdev" className="object-cover " />
        </ServiceCard>
      </div>
